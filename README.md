...
<h2>Алгоритм решения</h2>
Class1.cs:
если x > 9 и x < 100, то возвращаем true, иначе false
Program.cs:
1)Запрашиваем данные у пользователя
2)если метод возвращает true, то выводим сообщение: Число двузначное, иначе: Число не двузначное
...
<h2>Алгоритм решения</h2>
Class1.cs:
Если первое число равно второму и второе равно третьему, то возвращаем true, иначе false
Program.cs:
1)Запрашиваем данные у пользователя
2)если метод возвращает true, то выводим сообщение: "Числа равны", иначе: "Числа не равны"
...
<h2>Алгоритм решения</h2>
Class.cs:
Проверяем если второе число равно 0, то возвращаем 0, иначе возвращаем частное передаваемых чисел
Program.cs:
1)Запрашиваем данные у пользователя
2)
